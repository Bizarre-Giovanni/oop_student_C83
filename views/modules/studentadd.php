...
<div class="content-wrapper">
  <div class="container-fluid">
   <div class="row pt-2 pb-2">
     <div class="col-sm-12">
  	    <h1 class="page-title" style="font-size: 2em;text-align: center;color:cyan;">ADD STUDENT</h1>
     </div>
   </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-5 form-group">
                    ...
                    <input type="text" style="font-size: 2em;" class="form-control" id="txtLname" name="txtLname" value="" autocomplete="nope" required>
                </div>

                <div class="col-sm-5 form-group">
                    <label for="txtFname" style="font-size: 1.5em;">Firstname</label>
                    <input type="text" class="form-control" style="font-size: 2em;color:red;" name="txtFname" id="txtFname" required>
                </div>

                <div class="col-sm-2 form-group">
                    <label for="txtMi" style="font-size: 1.5em;">MI</label>
                    <input type="text" class="form-control" style="font-size: 2em;color:red;" name="txtMi" id="txtMi" required>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-9 form-group">
                    ...
                    <input type="text" style="font-size: 2em;" class="form-control" id="txtAddress" name="txtAddress" autocomplete="nope">
                </div>

                <div class="col-sm-3 form-group">
                    <label for="txtProgcode" style="font-size: 1.5em;">Acad Program</label>
                    <input type="text" class="form-control" style="font-size: 2em;color:red;" name="txtProgcode" id="txtProgcode" required>
                </div>
              </div>                                               
            </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-9">
                  <div class="float-sm-right">
                     ...
                     <button type="button" style="font-size: 1.2em;" class="btn btn-light btn-round px-5" id="btnPrint"><i class="fa fa-print"></i>&nbsp;&nbsp;Print</button> 
                  </div>
                </div>
              </div>
            </div>  <!-- footer -->
